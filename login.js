...
/*
        if (isValid) {
            ...
            window.location.href = "main.html"; // Specify the actual profile.html URL
        }
*/
        $("#email").focus();
    });
...
async function checkCredentials(user_email, user_password) {
    const url = 'https://itse-2374-app-3-back.onrender.com'; // Change the port if your server is running on a different port
    try {
